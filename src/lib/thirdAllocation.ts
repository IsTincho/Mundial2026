// Tabla OFICIAL de asignación de terceros del Mundial 2026 (FIFA, Annexe C).
// Las 495 combinaciones posibles de los 8 grupos cuyos terceros clasifican, cada
// una mapeada al cruce FIJO que la FIFA define (no un emparejamiento válido
// cualquiera). Clave: las 8 letras de grupo ORDENADAS alfabéticamente. Valor: 8
// letras = grupo del tercero que enfrenta a cada ganador, en el orden
// THIRD_WINNER_ORDER. Generada y verificada contra el reglamento oficial: para
// las 495 entradas el valor es una permutación exacta de la clave.
//
// Ej: terceros de {B,D,E,F,I,J,K,L} -> 1ºE enfrenta al 3º del grupo D.

// Orden de los 8 ganadores que reciben un tercero (coincide con la estructura
// oficial: 1A 1B 1D 1E 1G 1I 1K 1L). El valor de la tabla sigue este orden.
export const THIRD_WINNER_ORDER = ['A', 'B', 'D', 'E', 'G', 'I', 'K', 'L'] as const;
