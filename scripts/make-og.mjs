...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  <defs>
    <radialGradient id="glow" cx="50%" cy="-6%" r="75%">
      <stop offset="0%" stop-color="#3FE06B" stop-opacity=".16"/>
      <stop offset="58%" stop-color="#3FE06B" stop-opacity="0"/>
    </radialGradient>
    <radialGradient id="glow2" cx="8%" cy="104%" r="62%">
      <stop offset="0%" stop-color="#FFC54E" stop-opacity=".10"/>
      <stop offset="60%" stop-color="#FFC54E" stop-opacity="0"/>
    </radialGradient>
    <clipPath id="fr"><rect width="${fw}" height="${fh}" rx="7"/></clipPath>
  </defs>

  <rect width="1200" height="630" fill="#0A0E0A"/>
  <g opacity=".5"><rect width="1200" height="630" fill="url(#glow)"/></g>
  <rect width="1200" height="630" fill="url(#glow2)"/>

  <!-- líneas de cancha (cal) -->
  <g fill="none" stroke="rgba(255,255,255,0.05)" stroke-width="2">
    <line x1="600" y1="0" x2="600" y2="630"/>
    <circle cx="600" cy="315" r="150"/>
    <rect x="0" y="170" width="120" height="290"/>
    <rect x="1080" y="170" width="120" height="290"/>
  </g>
  <circle cx="600" cy="315" r="5" fill="rgba(255,255,255,0.06)"/>
  <rect x="8" y="8" width="1184" height="614" fill="none" stroke="rgba(255,255,255,.10)" stroke-width="2" rx="10"/>

  <text x="600" y="120" text-anchor="middle" font-family="'JetBrains Mono','Consolas',monospace" font-size="26" letter-spacing="9" fill="#3FE06B">P R O D E · M U N D I A L</text>

  <text x="600" y="300" text-anchor="middle" font-family="Impact,'Arial Narrow',sans-serif" font-weight="700" font-size="210" letter-spacing="2" fill="#F4F4F2">MUNDIAL <tspan fill="#FFC54E">26</tspan></text>
  ...
  <text x="600" y="592" text-anchor="middle" font-family="Impact,'Arial Narrow',sans-serif" font-size="30" letter-spacing="3" fill="#8E8E89">DESARROLLADO POR <tspan fill="#3FE06B">ISTINCHO</tspan></text>
</svg>`;
