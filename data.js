/* ============================================================================
   data.js — Datos semilla del Prode Mundial 2026 (fase de grupos)
   ----------------------------------------------------------------------------
   ...
   Esquema de cada partido:
     g    -> grupo (A..L)
     f    -> fecha / jornada (1, 2, 3)
     d    -> fecha calendario (ISO, YYYY-MM-DD)
     h, a -> local, visita (nombres en español)
     p    -> pronóstico [local, visita]
     c    -> confianza del modelo (0–10)
     r    -> resultado real [local, visita] o null si no se jugó/cargó
     live -> true si el partido está en juego (sin resultado final)
   ============================================================================ */
...
window.PRODE_DATA = {
  ...
  // El ranking es informativo y se usa solo como criterio de orden estable
  // cuando dos equipos empatan en puntos, DG y GF (ver app.js).
  groups: {
